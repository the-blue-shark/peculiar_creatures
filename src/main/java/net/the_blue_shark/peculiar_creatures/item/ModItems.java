...
public class ModItems {
    public static final Item SPECTRE_DISC = registerItem("spectre_music_disk", setting -> new SimplePolymerItem(setting.jukeboxPlayable(ModSounds.SPECTRE_KEY).maxCount(1)));
