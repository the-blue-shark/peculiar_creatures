...
public class ModEntities {
    ...
    public static final EntityType<SmurfCatEntity> SMURF_CAT = register(Identifier.fromNamespaceAndPath(PeculiarCreaturesMod.MOD_ID, "smurf_cat"),
            EntityType.Builder.<SmurfCatEntity>of(SmurfCatEntity::new, MobCategory.CREATURE).sized(0.3f, 0.6f)
    );
